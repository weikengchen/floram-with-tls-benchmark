...
void offline_prf_oct(uint8_t * dest1, uint8_t * dest2, uint8_t * dest3, uint8_t * dest4,
	...
	__m128i or1, or2, or3, or4, or5, or6, or7, or8;
    ...
    or3 = _mm_load_si128((__m128i *) src3);
    or4 = _mm_load_si128((__m128i *) src4);
    or5 = _mm_load_si128((__m128i *) src5);
    or6 = _mm_load_si128((__m128i *) src6);
    or7 = _mm_load_si128((__m128i *) src7);
    or8 = _mm_load_si128((__m128i *) src8);
    ...
    mr3 = _mm_xor_si128(mr3, or3);
    mr4 = _mm_xor_si128(mr4, or4);
    mr5 = _mm_xor_si128(mr5, or5);
    mr6 = _mm_xor_si128(mr6, or6);
    mr7 = _mm_xor_si128(mr7, or7);
    mr8 = _mm_xor_si128(mr8, or8);

    _mm_storeu_si128((__m128i*) dest1, mr1);
    _mm_storeu_si128((__m128i*) dest2, mr2);
    _mm_storeu_si128((__m128i*) dest3, mr3);
    _mm_storeu_si128((__m128i*) dest4, mr4);
    _mm_storeu_si128((__m128i*) dest5, mr5);
    _mm_storeu_si128((__m128i*) dest6, mr6);
    _mm_storeu_si128((__m128i*) dest7, mr7);
    _mm_storeu_si128((__m128i*) dest8, mr8);
}
